...
import 'package:path_provider/path_provider.dart'; // 저장 라이브러리
...
class _MainpageState extends State<Mainpage> {
  ...
  String audioPath = ""; // 녹음된 파일의 경로를 저장하는 변수
  late CameraControlWidget cameraControl; //카메라 녹화 클래스 인스턴스

  @override
  void initState() {
    super.initState();
    audioPlayer = AudioPlayer(); //AudioPlayer 객체 초기화
  ...
  void dispose() {
    super.dispose();
    audioRecord.dispose(); //AudioRecorder 자원 해제
            ...
            Row(
              ...
              children: <Widget>[
                IconButton( // 녹음 시작 중지 버튼
                  ...
                  onPressed: isAudioRecording ? stopRecording : startRecording,
                ),
                IconButton(
                  icon: Icon(
